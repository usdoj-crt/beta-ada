const sidenav = () => {
    ...
    function expandAll(e) {
        ...
        e.target.querySelector('.usa-icon').outerHTML = expandingAll ? '<svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><use xlink:href="/assets/images/uswds/sprite.svg#expand_less"></use></svg>' : '<svg class="usa-icon" aria-hidden="true" focusable="false" role="img"><use xlink:href="/assets/images/uswds/sprite.svg#expand_more"></use></svg>';
    }
