...
In addition, anyone can call the [ADA Information Line]( {{'/infoline/' | relative_url}}) at {{site.contact.tollfree}} (voice) or {{site.contact.tty}} (TTY) with questions about their rights or responsibilities under the ADA. ADA Specialists are available to answer questions Monday through Friday.
