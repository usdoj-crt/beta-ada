...
{% details 1. What is the effective compliance date of the ADA standards for accessible pools? %}
...
{% details 2. What does the ADA require for accessibility of pools? %}
...
{% details 3. Does a community pool have to provide an accessible means of exit and entry? %}
...
{% details 4. My pool already existed before the effective date of the new rule. What am I required to do to provide pool access to customers with mobility disabilities? %}  
...
{% details 5. Are there any tax credits or deductions to help me comply? %}  
...
{% details 6. What if I can’t afford to install a fixed lift in my pool, or it would be difficult to do so? %}  
...
{% details 7. What is the difference between a “portable” lift and a “fixed” lift? %}  
...
{% details 8. How do I determine if it is readily achievable for me to install a lift in my existing pool? %}  
...
{% details 9. I already purchased a portable lift before March 15, 2012.  Can I still use it? %}  
...
{% details 10. I do not have a lift at my pool and it is not readily achievable to provide one now.  Do I have to close the pool? %}  
...
{% details 11. I’ve decided that it is readily achievable to provide a lift, but the lift I ordered is on back order. Do I have to close my pool until the lift arrives? %}  
No.  A business in this situation should order and install a compliant lift and install it when it becomes available.  
{% enddetails %}

## Other Questions  

{% details 12. What if I have two pools or a pool and a spa?  Can I share a lift between pools? %}  
...
{% details 13. If I can’t provide a lift at every pool, do I have to close the one(s) that has no lift? %}  
No.  If it is not readily achievable to provide a lift at each pool, the inaccessible pool(s) may remain open.  
{% enddetails %}  

{% details 14. Do I have to leave my pool lift out at poolside when my pool is closed? %}
...
{% details 15. Can I store my lift and bring it out only when it is requested by a person with a disability? %}  
...
{% details 16. I think a lift poses a safety risk at an unattended pool.  I also have heard that my insurance rates will increase if I have a lift in my unattended pool. Can I consider safety risks? %}  
...
{% details 17. I’ve provided a pool lift.  Do I have any further legal obligations? %}  
...
{% details 18. What is the Department's approach going to be to ensuring compliance with the new regulation pertaining to pool lifts? %}  
...
## Resources  
{% details 19. If I have a question about the new requirements, where do I go? %}
