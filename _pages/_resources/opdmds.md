...
| {% asset project-images/opdmd1.jpg alt="Drawing of a woman in a power wheelchair, a man on a Segway<sup>®</sup>, and a man sitting in a golf car" %} |  
...
| {% asset project-images/opdmd2.jpg alt="Drawing of a man using a Segway<sup>®</sup> reaching for an item in a grocery store cooler" %} |  
|:-:|
| <b>A man using a Segway in a grocery store</b> |  
...
| {% asset project-images/opdmd3.jpg alt="Drawing of a man with two small children and a man using a Segway<sup>®</sup> passing in a store aisle" %} |  
...
| {% asset project-images/opdmd4.jpg alt="Drawing of a store employee having a conversation with a man using a Segway<sup>®</sup>" %} |
