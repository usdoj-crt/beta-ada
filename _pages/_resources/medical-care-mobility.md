...
| <img src="{{ '/assets/project-images/AdjHhtTableScooter.jpg' | relative_url }}" alt="Illustration showing a man lying on an exam table while a doctor does an exam.  A motorized scooter is positioned next to the table." /> |
