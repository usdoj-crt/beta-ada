...
{% details Q6. What can be done to avoid these situations? expandable %}  
...
{% details Q7: What if someone is demonstrating threatening behavior because of his or her disability? expandable %}  
...
{% details Q8: What procedures should law enforcement officers follow to arrest and transport a person who uses a wheelchair? expandable %}  
...
{% details Q9: What steps should officers follow to communicate effectively with an individual who is blind or visually impaired? expandable %}  
...
{% details Q10: Do police personnel need to take special precautions when providing emergency medical services to someone who has HIV or AIDS? expandable %}
...
{% details Q11: Do police departments have to arrange for a sign language interpreter every time an officer interacts with a person who is deaf? expandable %}  
...
{% details Q12: If the person uses sign language, what kinds of communication will require an interpreter? expandable %}  
...
{% details Q13: Do I have to take a sign language interpreter to a call about a violent crime in progress or a similar urgent situation involving a person who is deaf? expandable %}  
...
{% details Q14: When a sign language interpreter is needed, where do I find one? expandable %}
...
{% details Q15: Is there any legal limit to how much my department must spend on communication aids like interpreters? expandable %}  
...
{% details Q16: When would an officer use an assistive listening device as a communication aid? expandable %}  
...
{% details Q17: What is a TTY and does every police station have to have one? expandable %}  
...
{% details Q20: Does the ADA require all police stations to be accessible to people with disabilities? expandalbe %}  
...
{% details Q21: What about holding cells and jails that are not accessible? expandable %}  
...
{% details Q22: Is there a limit to the amount of money my agency must spend to alter an existing police facility? expandable %}  
...
{% details Q23. We are building a new prison. Do we need to make it accessible? expandable %}  
...
{% details Q24: What types of modifications in law enforcement policies, practices, and procedures does the ADA require? expandable %}  
...
{% details Q25: It sounds like awareness and training are critical for effective interaction with individuals with disabilities. How can I find out more about the needs of my local disability community? expandable %}  
...
{% details Q26: Where can I turn for answers to other questions about the ADA? expandable %}  
**A**: The Department of Justice's toll-free ADA Information Line answers questions and offers free publications about the ADA. The telephone numbers are: 800-514-0301 (voice) or 833-610-1264 (TTY). Publications are also available from the [ADA Website]( {{'/index'| relative_url}})
{% enddetails %}