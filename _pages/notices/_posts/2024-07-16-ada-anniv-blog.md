---
title_es: "Happy 34th Anniversary ADA"
title: "Happy 34th Anniversary ADA"
compact: true
sidenav: true
print: true
...
description: The Department of Justice published a Notice of Proposed Rulemaking
  ...
  Title II of the ADA.
publish-date: 2024-07-16 00:00:00
---
...
The ADA requires that state and local governments must provide individuals with disabilities with
...
The ADA requires that state and local governments have to provide individuals with disabilities
...
need to meet WCAG 2.1, Level AA.
  ...
  - **Example:** A message that a member of the public posts on a town’s online message board
...
For more information, see the [final rule]({{'assets/pdfs/web-rule.pdf' | relative_url}}) in the section of the appendix called
