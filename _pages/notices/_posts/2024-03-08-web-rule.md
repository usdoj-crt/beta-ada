...
{% accordion summary1b expandable %}
{% collapsible %}
...
**Example that meets the rule:** A State’s webpage with information about a park has text with a
color contrast ratio that is 4.45:1. WCAG 2.1, Level AA requires a color contrast ratio of 4.5:1 for
this text. It can be hard for some people with vision disabilities to see text on a webpage if there
