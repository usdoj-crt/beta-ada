...
lead: |-
  The Department of Justice (Department) published a final rule updating its regulations for Title II of the Americans with Disabilities Act (ADA). The final rule has specific requirements about how to ensure that web content and mobile applications (apps) are accessible to people with disabilities.
...
tags:
  ...
  - title ii
---
**Purpose of this fact sheet:** This fact sheet gives a summary of the rule. The summary is designed to provide introductory information about the rule’s requirements, particularly for people who may not have a legal background. For more information, please read the full rule at [link to Fed. Reg./ADA.gov].
