...
tags:
  ...
  - title ii
---
**Purpose of this fact sheet:** This fact sheet gives a summary of the rule. The summary is designed to provide introductory information about the rule’s requirements, particularly for people who may not have a legal background. [For more information, please read the full rule]({{'assets/pdfs/web-rule.pdf' | relative_url}}).
...
updated the rule is available in the appendix to the [rule]({{'assets/pdfs/web-rule.pdf' | relative_url}}).
{% enddetails %}
...
content” in the [rule]({{'assets/pdfs/web-rule.pdf' | relative_url}}) in the section of the appendix called “Definitions.”
{% enddetails %}
...
- For more information about fundamental alteration and undue burden, see the [final rule]({{'assets/pdfs/web-rule.pdf' | relative_url}}) in the section of the appendix called “§ 35.204 Duties”
...
[final rule]({{'assets/pdfs/web-rule.pdf' | relative_url}}) in the section of the appendix called “§ 35.202 Conforming
Alternate Versions.”
