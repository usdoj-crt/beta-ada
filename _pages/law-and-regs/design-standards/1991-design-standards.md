...
{% figure Figure 1 %}
<img src="{{ '/assets/design-standards/figure_1_minimum_clear_width_for_single_wheelchair.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 24e %}
<img src="{{ '/assets/design-standards/figure_24e_max_doorway_depth.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 2 %}
<img src="{{ '/assets/design-standards/fig_2_min_clear_width_two_wheelchairs.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 3 %}
<img src="{{ '/assets/design-standards/fig_3_wheelchair_turning_space.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 4 %}
<img src="{{ '/assets/design-standards/fig_4_min_clear_floor_space_wheelchairs.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 4a %}
<img src="{{ '/assets/design-standards/fig_4a_clear_floor_space.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 4b %}
<img src="{{ '/assets/design-standards/fig_4b_forward_approach.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 4c %}
<img src="{{ '/assets/design-standards/fig_4c_parallel_approach.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 4d %}
<img src="{{ '/assets/design-standards/fig_4d_clear_floor_space_alcoves.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 4e %}
<img src="{{ '/assets/design-standards/fig_4e_additional_maneuvering_clearances.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 5 %}
<img src="{{ '/assets/design-standards/fig_5_forward_reach.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 5a %}
<img src="{{ '/assets/design-standards/fig_5a_high_forward_reach.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 5b %}
<img src="{{ '/assets/design-standards/fig_5b_max_forward_reach_over_obstruction.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 6 %}
<img src="{{ '/assets/design-standards/fig_6_side_reach.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 6a %}
<img src="{{ '/assets/design-standards/fig_6a_clear_floor_space_parallel.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 6b %}
<img src="{{ '/assets/design-standards/fig_6b_high_and_low_side_reach_limits.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 6c %}
<img src="{{ '/assets/design-standards/fig_6c_max_side_reach_obstruction.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 7 %}
<img src="{{ '/assets/design-standards/fig_7_accessible_route.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 7a %}
<img src="{{ '/assets/design-standards/fig_7a_90_degree_turn.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 7b %}
<img src="{{ '/assets/design-standards/fig_7b_turns_around_obstruction.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 8a %}
<img src="{{ '/assets/design-standards/fig_8a_walking_parallel_to_wall.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 8b %}
<img src="{{ '/assets/design-standards/fig_8b_walking_perpendicular_to_wall.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 8c %}
<img src="{{ '/assets/design-standards/fig_8c_free_standing_objects.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 8d %}
<img src="{{ '/assets/design-standards/fig_8d_objects_mounted_on_pylons.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 8e %}
<img src="{{ '/assets/design-standards/fig_8e_example_protection.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 8 C-1 %}
<img src="{{ '/assets/design-standards/fig_8c1_overhead_hazards.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 7c %}
<img src="{{ '/assets/design-standards/fig_7c_changes_in_level.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 7d %}
<img src="{{ '/assets/design-standards/fig_7d_changes_in_level.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 8f %}
<img src="{{ '/assets/design-standards/fig_8f_carpet_pile_thickness.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 8g %}
<img src="{{ '/assets/design-standards/fig_8g_gratings.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 8h %}
<img src="{{ '/assets/design-standards/fig_8h_grating_orientation.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 9 %}
<img src="{{ '/assets/design-standards/fig_9_dimensions_of_parking_spaces.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 10 %}
<img src="{{ '/assets/design-standards/fig_10_access_aisle.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 11 %}
<img src="{{ '/assets/design-standards/fig_11_measurement_of_curb_ramp_slopes.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 12a %}
<img src="{{ '/assets/design-standards/fig_12a_flared_sides.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 12b %}
<img src="{{ '/assets/design-standards/fig_12b_returned_curb.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 13 %}
<img src="{{ '/assets/design-standards/fig_13_build_up_curb_ramp.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 15 %}
<img src="{{ '/assets/design-standards/fig_15_curb_ramps_at_marked_crossings.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 15c %}
<img src="{{ '/assets/design-standards/fig_15c.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 15d %}
<img src="{{ '/assets/design-standards/fig_15d.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 15a %}
<img src="{{ '/assets/design-standards/fig_15a.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 15b %}
<img src="{{ '/assets/design-standards/fig_15b.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 16 %}
<img src="{{ '/assets/design-standards/fig_16_components_of_single_ramp.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 17 %}
<img src="{{ '/assets/design-standards/fig_17_examples_of_edge_protection.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 18a %}
<img src="{{ '/assets/design-standards/fig_18a_flush_riser.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 18 %}
<img src="{{ '/assets/design-standards/fig_18_usable_tread.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 19a %}
<img src="{{ '/assets/design-standards/fig_19a_plan.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 19b %}
<img src="{{ '/assets/design-standards/fig_19b_elevation_of_center_handrail.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 19c %}
<img src="{{ '/assets/design-standards/fig_19c_extension_at_bottom.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 19d %}
<img src="{{ '/assets/design-standards/fig_19d_extension_at_top.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 20 %}
<img src="{{ '/assets/design-standards/fig_20_hoistway.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 21 %}
<img src="{{ '/assets/design-standards/fig_21_graph_of_timing_eq.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 22 %}
<img src="{{ '/assets/design-standards/fig_22_min_dimensions_of_elevator_cars.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 23a %}
<img src="{{ '/assets/design-standards/fig_23a_panel_detail.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 23b %}
<img src="{{ '/assets/design-standards/fig_23b_car_control_height.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 23c %}
<img src="{{ '/assets/design-standards/fig_23c_alternate_locations_of_panel.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 23d %}
<img src="{{ '/assets/design-standards/fig_23d_alternate_locations_of_panel.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 24a %}
<img src="{{ '/assets/design-standards/fig_24a.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 24b %}
<img src="{{ '/assets/design-standards/fig_24b_hinged_door.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 24c %}
<img src="{{ '/assets/design-standards/fig_24c_sliding_door.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 24d %}
<img src="{{ '/assets/design-standards/fig_24d_folding_door.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 25 %}
<img src="{{ '/assets/design-standards/fig_25_maneuvering_clearances.gif' | relative_url }}" alt="" />
{% figcaption %}
...
<img src="{{ '/assets/design-standards/fig25-2.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 26 %}
<img src="{{ '/assets/design-standards/fig_26_two_hinged_doors.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 27a %}
<img src="{{ '/assets/design-standards/fig_27a_spout_height.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 27b %}
<img src="{{ '/assets/design-standards/fig_27b_clear_floor_space.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 27c %}
<img src="{{ '/assets/design-standards/fig_27c_free_standing_fountain.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 27d %}
<img src="{{ '/assets/design-standards/fig_27d_built_in_fountain.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 28 %}
<img src="{{ '/assets/design-standards/fig_28_clear_floor_space_water_closets.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 29 %}
<img src="{{ '/assets/design-standards/fig_29_grab_bars.gif' | relative_url }}" alt=""/>
{% figcaption %}
...
{% figure Figure 29b %}
<img src="{{ '/assets/design-standards/fig_29b_sidewall.gif' | relative_url }}"  alt=""/>
{% figcaption %}
...
{% figure Figure 30a %}
<img src="{{ '/assets/design-standards/fig_30a_standard_stall.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 30b %}
<img src="{{ '/assets/design-standards/fig_30b_alternate_stalls.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 30 %}
<img src="{{ '/assets/design-standards/fig_30_toilet_stalls.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 30c %}
<img src="{{ '/assets/design-standards/fig_30c_rear_wall.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 30d %}
<img src="{{ '/assets/design-standards/fig_30d_side_walls.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 31 %}
<img src="{{ '/assets/design-standards/fig_31_lavatory_clearances.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 32 %}
<img src="{{ '/assets/design-standards/fig_32_clear_floor_space.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 33 %}
<img src="{{ '/assets/design-standards/fig_33_clear_floor_space_bathtubs.gif' | relative_url }}" alt="" />
{% figcaption %}
...
<p><strong>Figure 33(b) With Seat at Head of Tub.</strong> If the approach is parallel to the bathtub, a 30 inches (760 mm) minimum width by 75 inches (1905 mm) minimum length clear space is required alongside the bathtub. The seat width shall be 15 inches (380 mm), measured from the back wall to the front of the seat, and shall extend the full width of the tub. An accessible lavatory is permitted within the clear space at the foot end of the tub.</p>
...
{% figure Figure 34 %}
<img src="{{ '/assets/design-standards/fig_34_grab_bars_bathtubs.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 35a %}
<img src="{{ '/assets/design-standards/fig_35a.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 35b %}
<img src="{{ '/assets/design-standards/fig_35b.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 36 %}
<img src="{{ '/assets/design-standards/fig_36.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 57 %}
<img src="{{ '/assets/design-standards/fig_57.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 37 %}
<img src="{{ '/assets/design-standards/fig_37.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 38a %}
<img src="{{ '/assets/design-standards/fig_38a.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 38b %}
<img src="{{ '/assets/design-standards/fig_38b.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 39a %}
<img src="{{ '/assets/design-standards/fig_39a.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 39b %}
<img src="{{ '/assets/design-standards/fig_39b.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 39c %}
<img src="{{ '/assets/design-standards/fig_39c.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 39d %}
<img src="{{ '/assets/design-standards/fig_39d.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 39e %}
<img src="{{ '/assets/design-standards/fig_39e.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 43a %}
<img src="{{ '/assets/design-standards/fig_43a.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 43b %}
<img src="{{ '/assets/design-standards/fig_43b.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 43c %}
<img src="{{ '/assets/design-standards/fig_43c.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 43d %}
<img src="{{ '/assets/design-standards/fig_43d.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 44 %}
<img src="{{ '/assets/design-standards/fig_44.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 45 %}
<img src="{{ '/assets/design-standards/fig_45.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 46 %}
<img src="{{ '/assets/design-standards/fig_46.gif' | relative_url }}" alt="" />
{% figcaption %}
...
Where mirrors are provided in dressing rooms of the same use, then in an accessible dressing room, a full-length mirror, measuring at least 18 in wide by 54 in high (460 mm by 1370 mm), shall be mounted in a position affording a view to a person on the bench as well as to a person in a standing position.
...
{% figure Figure 53 %}
<img src="{{ '/assets/design-standards/fig_53.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 54 %}
<img src="{{ '/assets/design-standards/fig_54.gif' | relative_url }}" alt="" />
{% figcaption %}
...
(3) \* Assistive Listening Devices. _(Reserved)_
...
{% figure Figure 55 %}
<img src="{{ '/assets/design-standards/fig_55.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 56 %}
<img src="{{ '/assets/design-standards/fig_56.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 57a %}
<img src="{{ '/assets/design-standards/fig_57a.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure 57b %}
<img src="{{ '/assets/design-standards/fig_57b.gif' | relative_url }}" alt="" />
{% figcaption %}
...
(8) Security Systems. _(Reserved)_.
...
{% figure Figure A1 %}
<img src="{{ '/assets/design-standards/fig_a1.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure A2 %}
<img src="{{ '/assets/design-standards/fig_a2.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure A3 %}
<img src="{{ '/assets/design-standards/fig_a3.gif' | relative_url }}" alt="" />
{% figcaption %}
...
{% figure Figure A3a%}
<img src="{{ '/assets/design-standards/figa3a.gif' | relative_url }}" alt="" />
{% figcaption %}
...
Potential hazardous objects are noticed only if they fall within the detection range of canes (see [Fig. A4](#figurea4)). Visually impaired people walking toward an object can detect an overhang if its lowest surface is not higher than 27 in (685 mm). When walking alongside protruding objects, they cannot detect overhangs. Since proper cane and service animal techniques keep people away from the edge of a path or from walls, a slight overhang of no more than 4 in (100 mm) is not hazardous.

{% figure Figure A4 %}
<img src="{{ '/assets/design-standards/fig_a4.gif' | relative_url }}" alt="" />
{% figcaption %}
...
The requirements for stair and ramp handrails in this guideline are for adults. When children are principal users in a building or facility, a second set of handrails at an appropriate height can assist them and aid in preventing accidents.
...
Sliding automatic doors do not need guard rails and are more convenient for wheelchair users and visually impaired people to use. If slowly opening automatic doors can be reactivated before their closing cycle is completed, they will be more convenient in busy doorways.
...
[Fig. A6(a) and (b)](#figurea6) show the diagonal and side approaches most commonly used to transfer from a wheelchair to a water closet. Some wheelchair users can transfer from the front of the toilet while others use a 90-degree approach. Most people who use the two additional approaches can also use either the diagonal approach or the side approach.

{% figure Figure A6 %}
<img src="{{ '/assets/design-standards/fig_a6.gif' | relative_url }}" alt="" />
{% figcaption %}
...
[Figure A7](#figurea7) shows two possible configurations of a toilet room with a roll-in shower. The specific shower shown is designed to fit exactly within the dimensions of a standard bathtub. Since the shower does not have a lip, the floor space can be used for required maneuvering space. This would permit a toilet room to be smaller than would be permitted with a bathtub and still provide enough floor space to be considered accessible. This design can provide accessibility in facilities where space is at a premium (i.e., hotels and medical care facilities). The alternate roll-in shower ([Fig. 57b](#figure57b)) also provides sufficient room for the &quot;T-turn&quot; and does not require plumbing to be on more than one wall.

{% figure Figure A7 %}
<img src="{{ '/assets/design-standards/fig_a7.gif' | relative_url }}" alt="" />
{% figcaption %}
...
Locating visual emergency alarms in rooms where persons who are deaf may work or reside alone can ensure that they will always be warned when an emergency alarm is activated. To be effective, such devices must be located and oriented so that they will spread signals and reflections throughout a space or raise the overall light level sharply. However, visual alarms alone are not necessarily the best means to alert sleepers. A study conducted by Underwriters Laboratory (UL) concluded that a flashing light more than seven times brighter was required (110 candela v. 15 candela, at the same distance) to awaken sleepers as was needed to alert awake subjects in a normal daytime illuminated room.
...
Illustrations of practices prohibited by this section are contained in paragraph (c), which is modeled on a similar provision in the regulations issued by the Department of Housing and Urban Development to implement the Fair Housing Act (see 24 CFR 100.400(c)(1)). Prohibited actions may include:
...
If final regulations have not been issued pursuant to this section, for new construction for which a **_building permit is obtained prior to the issuance of final regulations_** (interim standards apply).
...
New construction and alterations of both public accommodations and commercial facilities must be made readily accessible to and usable by individuals with disabilities **_. Essentially, [this requirement] is designed to ensure that patrons and employees of public accommodations and commercial facilities are able to get to, enter and use the facility_**. The rationale for making new construction accessible applies with equal force to alterations.
