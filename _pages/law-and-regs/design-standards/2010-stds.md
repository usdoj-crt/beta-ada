...
<img src="{{/assets/project-images/cfr_addagcombo.jpg | relative_url}}" alt="a figure showing 28 CFR part 35.151 plus the 2004 ADAAG equal the 2010 ADA Standards for title II facilities" />
...
<img src="{{/assets/project-images/subprtd_addagcombo.jpg | relative_url}}" alt="figure showing the 28 CFR Part 36 Subpart D plus the 2004 ADAAG equals the 2010 Standards for Accessible Design for title III" />
...
{% figure Figure 302.2 %}
<img src="{{/assets/project-images/ADA-AB2.gif | relative_url}}" alt="Carpet is shown in cross section with a pile height of 1/2 inch (13 mm) maximum, measured from the backing." />
{% figcaption %}
...
{% figure Figure 302.3 %}
<img src="{{/assets/project-images/ADA-AB3.gif | relative_url}}" alt="Elongated openings, such as in a grating, are shown in plan view with openings 1/2 inch (13 mm) maximum in one dimension. The other dimension is longer (unspecified) and is perpendicular to the dominant direction of travel." />
{% figcaption %}
...
{% figure Figure 303.2 %}
<img src="{{/assets/project-images/ADA-AB4.gif | relative_url}}" alt="Elevation drawing of a change in level between the surfaces of two parallel planes with a vertical edge that is 1/4 inch (6.4 mm) high maximum." />
{% figcaption %}
...
{% figure Figure 303.3 %}
<img src="{{/assets/project-images/ADA-AB5.gif | relative_url}}" alt="Elevation drawing of a change in level 1/4 to 2 inches (6.4 - 13 mm) high that is beveled with a slope of 1:2." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB6.gif | relative_url}}" alt="The T shape space is 36 inches (915 mm) wide at the top and stem within a 60 inch by 60 inch (1525 mm by 1525 mm) square." />
{% figcaption %}
...
{% figure Figure 305.3 %}
<img src="{{/assets/project-images/ADA-AB7.gif | relative_url}}" alt="Clear floor or ground space is 30 inches by 48 inches (760 mm by 1220 mm) minimum." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB9.gif | relative_url}}" alt="For a forward approach, if the depth of the alcove is greater than 24 inches (610 mm), the clear floor or ground space within the alcove must be 36 inches (915 mm) wide minimum." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB10.gif | relative_url}}" alt="For a parallel approach, if the depth of the alcove is greater than 15 inches (380 mm), then the length of the clear floor or ground space within the alcove must be 60 inches (1525 mm) minimum." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB16.gif | relative_url}}" alt="A side view is shown of a person suing a wheelchair reaching toward a wall.  The lowest vertical reach point is 15 inches (380 mm) minimum and the highest is 48 inches (1220 mm) maximum." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB18.gif | relative_url}}" alt="The drawing shows a frontal view of a person using a wheelchair making a side reach to a wall.  The depth of reach is 10 inches (255 mm) maximum.  The vertical reach range is 15 inches (380 mm) minimum to 48 inches (1220 mm) maximum." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB29.gif | relative_url}}" alt="The cross section of a ramp with handrails is shown where the ramp surface extends 12 inches (305 mm) minimum to the outside of the handrails." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB30.gif | relative_url}}" alt="An elevation drawing shows a vertical clearance of less than 4 inches (100 mm) between the ramp surface and the bottom edge of a horizontal rail." />
{% figcaption %}
...
{% figure Figure 406.2 %}
<img src="{{/assets/project-images/ADA-AB31.gif | relative_url}}" alt="In cross section, a curb ramp with a maximum slope of 1:12 adjoins a surface at the bottom that has a maximum counter slope of 1:20." />
{% figcaption %}
...
{% figure Figure 406.3 %}
<img src="{{/assets/project-images/ADA-AB32.gif | relative_url}}" alt="A curb ramp with triangular flared sides is shown.  The flared sides have a maximum 1:10 slope, measured at the curb face." />
{% figcaption %}
...
{% figure Figure 406.4 %}
<img src="{{/assets/project-images/ADA-AB33.gif | relative_url}}" alt="A plan view of a curb ramp shows the required top landing which has a length of 36 inches (915 mm) minimum in the direction of the ramp run and is at least as wide as the ramp." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB36.gif | relative_url}}" alt="Visible signals are shown centered at 72 inches (1830 mm) minimum above the floor ground." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB37.gif | relative_url}}" alt="An enlarged detail of a tactile floor designation is shown.  The sign contains a star and the number A1 next to it which is 2 inches (51 mm) high; the braille equivalent is provided below each." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB38.gif | relative_url}}" alt="An enlarged detail shows the car designation below the floor designation.  The car designation is 2 inches (51 mm) minimum high with the braille equivalent below it." />
{% figcaption %}
...
<td><img src="{{/assets/project-images/ximage.gif | relative_url}}" alt="x icon" /></td>
<td><img src="{{/assets/project-images/brailalarm.gif | relative_url}}" alt="elevator stop braille button" /><br />"ST"OP Three cells</td>
</tr>
<tr>
<th scope="row">Alarm</th>
<td><img src="{{/assets/project-images/bellimage.gif | relative_url}}" alt="bell icon" /></td>
<td><img src="{{/assets/project-images/bellbrail.gif | relative_url}}" alt="elevator alarm braille button" /><br />AL"AR"M Four cells</td>
</tr>
<tr>
<th scope="row">Door Open</th>
<td><img src="{{/assets/project-images/arrows.gif | relative_url}}" alt="open arrows" /></td>
<td><img src="{{/assets/project-images/arrowsbrail.gif | relative_url}}" alt="elevator open doors braille button" /><br />"OP"EN Three cells</td>
</tr>
<tr>
<th scope="row">Door Close</th>
<td><img src="{{/assets/project-images/arrows2.gif | relative_url}}" alt="close arrows" /></td>
<td><img src="{{/assets/project-images/arrows2brail.gif | relative_url}}" alt="elevator close doors braille button" /><br />CLOSE Five cells</td>
</tr>
<tr>
<th scope="row">Main Entry Floor</th>
<td><img src="{{/assets/project-images/star.gif | relative_url}}" alt="star icon" /></td>
<td><img src="{{/assets/project-images/starbrail.gif | relative_url}}" alt="elevaor main floor braille button" /><br />MA"IN" Three cells</td>
</tr>
<tr>
<th scope="row">Phone</th>
<td><img src="{{/assets/project-images/phone.gif | relative_url}}" alt="phone icon" /></td>
<td><img src="{{/assets/project-images/phonebrail.gif | relative_url}}" alt="elevator phone braille button" /><br />PH"ONE" Four cells</td>
</tr>
</tbody>
</table>
...
<img src="{{/assets/project-images/ADA-AB42.gif | relative_url}}" alt="A plan view shows an elevator with an out-swinging hoistway door.  The control panel is shown on the car side wall 12 inches (305 mm) minimum from the front." />
{% figcaption %}
...
{% figure Figure 410.6 %}
<img src="{{/assets/project-images/ADA-AB43.gif | relative_url}}" alt="A rectangular lift platform is shown in plan view with an end door 32 inches (815 mm) minimum, and a side door 42 inches (1065 mm) minimum." />
{% figcaption %}
...
{% figure Figure 502.2 %}
<img src="{{/assets/project-images/ADA-AB44.gif | relative_url}}" alt="Two marked parking spaces are shown in plan view.  The car space is 96 inches (2440 mm) wide minimum and the van space is 132 inches (3350 mm) wide minimum, with an access aisle between them." />
{% figcaption %}
...
{% figure Figure 502.3 %}
<img src="{{/assets/project-images/ADA-AB45.gif | relative_url}}" alt="A van and a car parking space are shown in plan view sharing an access aisle.  The access aisle is shown to be 60 inches (1525 mm) wide minimum and as long as the parking space.  The entire length of the aisle area is to be marked." />
{% figcaption %}
...
{% figure Figure 503.3 %}
<img src="{{/assets/project-images/ADA-AB46.gif | relative_url}}" alt="An access aisle at a passenger loading zone is shown to be the full length of the vehicle pull-up space and 60 inches (1525 mm) wide minimum.  The aisle area is to be marked." />
{% figcaption %}
...
{% figure Figure 505.5 %}
<img src="{{/assets/project-images/ADA-AB57.gif | relative_url}}" alt="The clearance between the handrail and wall is shown to be 1 1/ 2 inches (38 mm) minimum." />
{% figcaption %}
...
{% figure Figure 505.6 %}
<img src="{{/assets/project-images/ADA-AB58.gif | relative_url}}" alt="A handrail with brackets attached to the bottom surface is shown in cross section.  The horizontal projection of the bracket from the wall is 1 1/2 inches (38 mm) below the bottom of the handrail." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB52.gif | relative_url}}" alt="Ramp handrails at the top and bottom are shown to extend horizontally above the landing 12 inches (305 mm) minimum from the ramp run.  The extensions return to posts." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB53.gif | relative_url}}" alt="The handrail extends horizontally above the landing for 12 inches (305 mm) minimum beginning directly above the first riser nosing." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB54.gif | relative_url}}" alt="A handrail is shown to extend at the slope of the stair flight for a horizontal distance equal to one tread depth beyond the last riser nosing." />
{% figcaption %}
...
{% figure Figure 602.5 %}
<img src="{{/assets/project-images/ADA-AB59.gif | relative_url}}" alt="In plan view, the spout is shown to be 15 inches (380 mm) minimum from the vertical support and 5 inches (125 mm) from the front edge of the unit." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB61.gif | relative_url}}" alt="The clearance around a water closet is shown in plan view to be 60 inches (1525 mm) wide minimum and 56 inches (1420 mm) deep minimum." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB63.gif | relative_url}}" alt="Elevation drawing shows the side wall grab bar to be 42 inches (1065) long minimum, located 12 inches (305 mm) maximum from the rear wall and extending 54 inches (1370 mm) minimum from the rear wall." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB64.gif | relative_url}}" alt="Elevation drawing shows the rear grab bar 36 inches (915 mm) long minimum, positioned so that 24 inches (610 mm) minimum extends toward the open transfer side and 12 inches (305 mm) minimum extends toward the side wall." />
{% figcaption %}
...
{% figure Figure 604.7 %}
<img src="{{/assets/project-images/ADA-AB65.gif | relative_url}}" alt="Elevation drawing shows the centerline of the toilet paper dispenser to be 7 to 9 inches (180 to 230 mm) in front of the water closet.  The outlet of the dispenser is 15 inches (380 mm) minimum and 48 inches (1220 mm) maximum above the floor." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB69.gif | relative_url}}" alt="The compartment is 60 inches (1525 mm) deep minimum and 35 to 37 inches (890 to 940 mm) wide, with grab bars on both sides.   The minimum clearance between the door side of the stall and any obstruction is 42 inches (1065 mm)." />
{% figcaption %}
...
{% figure Figure 607.5 %}
<img src="{{/assets/project-images/ADA-AB74.gif | relative_url}}" alt="Elevation drawing shows the location of controls above the tub rim and below the grab bar and between the front edge of the tub and the tub centerline." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB75.gif | relative_url}}" alt="A transfer stall is shown in plan view to be 36 by 36 inches (915 by 915 mm).  Clear floor space in front is 36 inches (915 mm) wide minimum and 48 inches (1220 mm) long minimum measured from the control wall." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB77.gif | relative_url}}" alt="A plan view shows the shower compartment is 36 inches (915 mm) wide absolute and 60 inches (1525 mm) deep minimum.  A 36 inch (915 mm) wide minimum entry is provided on one long wall.  A seat is provided adjacent to the entry on the same wall." />
{% figcaption %}
 ...
 **608.3.1 Transfer Type Shower Compartments.** In transfer type compartments, grab bars shall be provided across the control wall and back wall to a point 18 inches (455 mm) from the control wall.
 ...
 <img src="{{/assets/project-images/ADA-AB78.gif | relative_url}}" alt="Plan view shows a grab bar that extends across the control wall and the back wall to a point 18 inches (455 mm) from the control wall." />
 {% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB84.gif | relative_url}}" alt="Figure (a) shows a handrail with an approximately square cross section and figure (c) shows an elliptical cross section.  The largest cross section dimension is 2 inches (51 mm) maximum.  The perimeter dimension must be 4 to 4.8 inches (100 to 120 mm)." />
{% figcaption %}
...
{% figure Figure 609.3 %}
<img src="{{/assets/project-images/ADA-AB85.gif | relative_url}}" alt="A grab bar is shown with a projecting object mounted above and below it.  Projecting objects must spaced 1 ½ inch (38 mm) minimum below and 12 inches (305 mm) minimum above the grab bar.  Recessed objects can be spaced immediately above and below." />
{% figcaption %}
...
{% figure Figure 610.3 %}
<img src="{{/assets/project-images/ADA-AB87.gif | relative_url}}" alt="Figure (a) is a plan view of a rectangular seat and figure (b) is a plan view of an L-shaped seat.  The front edge of each is 3 inches (75 mm) maximum from the compartment entry." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB88.gif | relative_url}}" alt="The rear edge is 2 1/2 inches (64 mm) maximum and the front edge 15 to 16 inches (380 to 405 mm) from the seat wall.  The side edge is 1 1/2 inches (38 mm) maximum from the back wall." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB91.gif | relative_url}}" alt="An Enlarged detail shows the character height measured from the baseline of the character is 5/8 to 2 inches (16 to 51 mm) based on the uppercase letter I." />
{% figcaption %}
...
<img src="{{/assets/project-images/final_clip_image002_0000.jpg | relative_url}}" alt="Six Braille cells are shown indicating what is meant by dot diameter, distance between dots in the same cell, adjacent cells, corresponding from one cell directly below" />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB93.gif | relative_url}}" alt="An enlarged detail shows Braille dots positioned 3/8 inch (9.5 mm) minimum below tactile letters and 3/8 inch (9.5 mm) minimum separation from the sign border." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB94.gif | relative_url}}" alt="A tactile sign is shown mounted with the baseline of the lowest characters 48 inches (1220 mm) minimum and the baseline of the highest characters 60 inches (1525 mm) maximum above the finish floor." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB96.gif | relative_url}}" alt="The field height for a men's room pictogram is shown to be 6 inches (150 mm) minimum.  Tactile and Braille characters are located below, outside the pictogram field." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB97.gif | relative_url}}" alt="Pictogram that shows the simplified profile of a person seated in a wheelchair." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB98.gif | relative_url}}" alt="Pictogram of a TTY showing the keyboard and space bar typical of most devices and the shape of a telephone handset at the top." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB99.gif | relative_url}}" alt="Pictogram of a telephone handset in profile with radiating sound waves." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB89.gif | relative_url}}" alt="Pictogram with the shape of an ear and a bar diagonally across the shape." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB100.gif | relative_url}}" alt="The maximum distance from the face of the telephone to the edge of the telephone enclosure is 10 inches (255 mm).  Clear floor space for a parallel approach is located in front of the enclosure." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB101.gif | relative_url}}" alt="The maximum distance from the front edge of a counter within the telephone enclosure to the face of the telephone is 20 inches (510 mm).  The telephone enclosure overlaps the clear floor space for a forward approach." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB103.gif | relative_url}}" alt="Figure(a) shows a 12-key number pad ascending layout. Figure (b) shows a 12-key descending number pad layout " />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB104.gif | relative_url}}" alt="Figure (a) is a plan view of a single wheelchair space 36 inches (915 mm) wide minimum.  Figure (b) is a plan view of two wheelchair spaces side by side.  Each space is 33 inches (840 mm) wide minimum." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB105.gif | relative_url}}" alt="Figure (a) shows a wheelchair space that can be entered from the front or rear that is 48 inches (1220 mm) deep minimum.  Figure (b) shows a wheelchair space entered from the side that is 60 inches (1525 mm) deep minimum." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB106.gif | relative_url}}" alt="Elevation drawing shows a person using a wheelchair on an upper level of tiered seating having a line of sight over the heads of spectators seated in front." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB107.gif | relative_url}}" alt="Elevation drawing shows a person using a wheelchair on an upper level of tiered seating having a line of sight between the heads of spectators seated in front." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB108.gif | relative_url}}" alt="Elevation drawing shows a person using a wheelchair on an upper level of tiered seating elevated sufficiently to have a line of sight over the heads of spectators standing in front." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB109.gif | relative_url}}" alt="Elevation drawing shows a person using a wheelchair on an upper level of tiered seating elevated sufficiently to have a line of sight between the heads of spectators standing in front." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB110.gif | relative_url}}" alt="A plan view of a kitchen with appliances and cabinets on both sides of an aisle open on both ends shows the width of the central aisle as 40 inches (1015 mm) minimum." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB116.gif | relative_url}}" alt="A counter surface is shown in elevation with a maximum height of 38 inches (965 mm) above the floor or ground and with edge protection above the surface that is 2 inches (51 mm) high maximum." />
{% figcaption %}
...
{% figure Figure 904.4 %}
<img src="{{/assets/project-images/ADA-AB117.gif | relative_url}}" alt="A plan view shows a portion of a counter 24 inches (610 mm) long minimum at which is centered the long dimension of clear floor or ground space." />
{% figcaption %}
...
{% figure Figure 1003.3.1 %}
<img src="{{/assets/project-images/ADA-AB121.gif | relative_url}}" alt="An elevation drawing shows pier edge protection that is 4 inches (100 mm) high maximum and 2 inches (51 mm) thick maximum." />
{% figcaption %}
...
{% figure Figure 1003.3.2 %}
<img src="{{/assets/project-images/ADA-AB123.gif | relative_url}}" alt="A plan view shows that the width of the clear pier space can be 36 inches (915 mm) wide minimum for a length of 24 inches (610 mm) maximum where multiple 36 inch (915 mm) wide segments are separated by clear segments 60 by 60 inches (1525 by 1525 mm) minimum." />
{% figcaption %}
...
{% figure Figure 1003.3.2 %}
<img src="{{/assets/project-images/ADA-AB124.gif | relative_url}}" alt="An elevation drawing shows pier edge protection that is 4 inches (100 mm) high maximum and 2 inches (51 mm) thick maximum." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB128.gif | relative_url}}" alt="Figure (a) is an elevation drawing of a transfer step 8 inches (205 mm) high maximum.  Figure (b) is a plan view of a transfer step that is 14 inches (355 mm) deep minimum and 24 inches (610 mm) long minimum." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB129.gif | relative_url}}" alt="A plan view shows pool lift seat located over the deck 16 inches minimum from the edge of the pool, measured to the seat centerline." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB131.gif | relative_url}}" alt="An elevation drawing shows pool lift seat height to be 16 to 19 inches (405 to 485 mm) measured from the deck to the top of the seat surface when in the raised (load) position." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB132.gif | relative_url}}" alt="An elevation drawing shows a pool lift with the surface of the seat submerged to a water depth of 18 inches (455 mm) minimum below the stationary water level." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB133.gif | relative_url}}" alt="An elevation drawing shows a sloped entry with a submerged depth of 24 to 30 inches (610 to 760 mm) below the stationary water level at the landing." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB134.gif | relative_url}}" alt="An elevation drawing of a sloped entry shows handrails on both sides that provide a clear width of 33 to 38 inches (840 to 965 mm)." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB135.gif | relative_url}}" alt="A plan view shows clear deck space of 60 by 60 inches (1525 by 1525 mm) minimum adjacent to a transfer wall.  Figure (a) shows this space centered at one grab bar.  Figure (b) shows this space centered on the clearance between two grab bars." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB136.gif | relative_url}}" alt="An elevation drawing shows the height of a transfer wall as 16 to 19 inches (405 to 485 mm) measured from the deck." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB137.gif | relative_url}}" alt="A plan view shows a transfer wall with a depth of 12 to 16 inches (305 to 405 mm) and a length of 60 inches (1525 mm) minimum." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB139.gif | relative_url}}" alt="A plan view shows a transfer platform at the top of a series of transfer steps leading down into the water.  The platform at the top has a clear depth of 19 inches (485 mm) minimum and a clear width of 24 inches (610 mm) minimum." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB140.gif | relative_url}}" alt="A plan view shows clear deck space 60 by 60 inches (1525 by 1525 mm) minimum at the base of the transfer platform surface that is centered along a 24 inch minimum unobstructed side of the transfer platform." />
{% figcaption %}
...
<img src="{{/assets/project-images/ADA-AB141.gif | relative_url}}" alt="An elevation drawing shows transfer system steps that are 8 inches (205 mm) high maximum which extend to a water depth of 18 inches (455 mm) minimum below the stationary water level." />
{% figcaption %}
<strong>Transfer Steps</strong>
{% endfigcaption %}
{% endfigure %}
...
<img src="{{/assets/project-images/ADA-AB142.gif | relative_url}}" alt="A plan view shows a transfer system with each step having a tread clear depth of 14 to 17 inches (355 to 430 mm) and a tread clear width of 24 inches (610 mm) minimum." />
{% figcaption %}
