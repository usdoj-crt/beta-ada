...
/***/ "./_assets/js/utils/taSelectors/countVisibleArticles.js":
/*!**************************************************************!*\
  !*** ./_assets/js/utils/taSelectors/countVisibleArticles.js ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return /* binding */ countVisibleArticles; }\n/* harmony export */ });\nfunction countVisibleArticles() {\n  const elements = Array.from(document.querySelectorAll('li.visibilityTarget'));\n  let numVisible = [];\n  elements.forEach(elem => {\n    elem.style.display === 'block' ? numVisible.push(elem) : null;\n  });\n  return numVisible.length;\n}\n\n//# sourceURL=webpack://federalist-uswds-jekyll/./_assets/js/utils/taSelectors/countVisibleArticles.js?");
