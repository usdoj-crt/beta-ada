var paginationLogic = (function () {
  ...
  // buttons.
  var firstPage = (offsetArrayVal, offsetParamVal) => {
    return (
      offsetParamVal === 0 &&
  ...
  var secondPageEtc = (offsetArrayVal, offsetParamVal) => {
  ...
  var intermediatePages = (urlParams, offsetArrayVal, offsetParamVal) => {
    return (
  ...
  var secondToLastPage = (offsetArrayVal, offsetParamVal, resultsArray) => {
  ...
  var lastPage = (offsetArrayVal, offsetParamVal, resultsArray) => {
    return (
